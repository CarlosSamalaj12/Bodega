        ...
        {detailRow && (
          <div className="kardex-page__detail">
            <div className="kardex-page__detail-grid">
              ...
              <div className="kardex-page__detail-field">
                <span className="kardex-page__detail-label">Total línea</span>
                <span className="kardex-page__detail-value kardex-page__detail-value--lg">
                  {detailRow.total_linea != null
                    ? `Q ${Number(detailRow.total_linea).toFixed(2)}`
                    : '—'}
                </span>
              </div>
              <div className="kardex-page__detail-field">
              ...
              <div className="kardex-page__detail-field">
                ...
                <span className="kardex-page__detail-value">
                  {detailRow.no_documento ? (
                    <code className="kardex-page__doc">{detailRow.no_documento}</code>
                  ) : '—'}
                </span>
              </div>
              <div className="kardex-page__detail-field">
              ...
              <div className="kardex-page__detail-field kardex-page__detail-field--full">
                <span className="kardex-page__detail-label">Stock total</span>
                <span className="kardex-page__detail-value kardex-page__detail-value--lg">
                  {detailRow.stock_total_producto != null
                    ? `${detailRow.stock_total_producto} unidades`
                    : '—'}
                </span>
              </div>
              <div className="kardex-page__detail-field kardex-page__detail-field--full">
                ...
                <span className="kardex-page__detail-value">
                  {detailRow.observaciones || 'Sin observaciones'}
                </span>
              </div>
            </div>

            <div className="kardex-page__detail-actions">
              {/* Enlace al movimiento original */}
              {detailRow.tipo_movimiento === 'ENTRADA' && (
                <Button
                  size="sm"
                  variant="primary"
                  onClick={() => {
                    setDetailRow(null);
                    navigate(`/entradas?open=${detailRow.id_movimiento}`);
                  }}
                >
                  Ver entrada #{(detailRow).id_movimiento}
                </Button>
              )}
              {['SALIDA', 'TRANSFERENCIA', 'AJUSTE'].includes(detailRow.tipo_movimiento) && (
                <Button
                  size="sm"
                  variant="primary"
                  onClick={() => {
                    setDetailRow(null);
                    navigate(`/salidas?open=${detailRow.id_movimiento}`);
                  }}
                >
                  Ver salida #{(detailRow).id_movimiento}
                </Button>
              )}
              {detailRow.id_pedido && (
                <Button
                  ...
                  onClick={() => {
                    setDetailRow(null);
                    navigate(`/pedidos?open=${detailRow.id_pedido}`);
                  }}
                >
                  Ver pedido #{(detailRow).id_pedido}
                </Button>
              )}
            </div>
          </div>
